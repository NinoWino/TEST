...
def login():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        if account:
            ...
            # Redirect to home page (You might want to use a proper redirect instead)
...
def register():
    ...
    if request.method == 'POST':
        if 'username' in request.form and 'password' in request.form and 'email' in request.form:
            ...
            # You can add your registration logic here, e.g. save to DB

            msg = 'Registration successful!'  # or some success message

        else:
            # Form is empty or missing fields
